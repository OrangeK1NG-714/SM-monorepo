...
export function getTeacherList() {
  return http.get<ITeacherList>(`/api/teacher/detail`, undefined, undefined, { requireAuth: true })
}
...
export function selectStudent(data: ISelectStd) {
  return http.post(`/api/teacher/selectStudent`, data, undefined, undefined, { requireAuth: true })
}
/**
 *  老师选学生-即（修改学生选老师选项）
 */
export function updateChoose(data: ISelectStd) {
  return http.put(`/api/student/updateTeacher`, data, undefined, undefined, { requireAuth: true })
}
...
export function cancelSelect(data: ISelectStd) {
  return http.delete(`/api/teacher/cancelSelect`, data, undefined, { requireAuth: true })
}
...
export function getSelectState(data: ISelectStd) {
  return http.get(`/api/teacher/getSelectList`, data, undefined, { requireAuth: true })
}
...
export function isTeacherInActivity(activityId: string, teacherId: string) {
  return http.get<ITeacherListInActivity>(`/api/teacher/isInActivity`, {
    activityId,
    teacherId,
